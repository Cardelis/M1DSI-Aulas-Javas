...
public class main {
	...
	public static void main(String[] args) {
		...
		a = (int) y; // Casting: no casting explicito eu forco uma variavel a ser de um tipo.
		b = x; // nessa linha nao presissa

		System.out.println(a); // mostra na tela informacao que tem a variavel
		System.out.println(b); // mostra na tela informacao que tem a variavel
		...
		System.out.println("Voce tem " + idadePessoa);  // mostra na tela
		...
		case 7:
			...
			default:// deafult serve para indicar o que fazer quando nenhum caso atende a condicao imposta
